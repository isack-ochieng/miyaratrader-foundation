...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MiyaraTrader — Professional Cloud Trading Platform" },
      { name: "description", content: "MiyaraTrader is a cloud-based trading platform built around the Deriv ecosystem. Connect your account, trade smarter, and grow with a modern fintech workspace." },
      { name: "author", content: "MiyaraTrader" },
      { name: "theme-color", content: "#0b1220" },
      { property: "og:title", content: "MiyaraTrader — Professional Cloud Trading Platform" },
      { property: "og:description", content: "A modern trading workspace for the Deriv ecosystem. Connect, analyze, and trade with confidence." },
