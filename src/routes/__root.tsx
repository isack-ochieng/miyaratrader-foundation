...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MiyaraTrader — Account workspace" },
      { name: "description", content: "MiyaraTrader account access and management." },
      { name: "author", content: "MiyaraTrader" },
      { name: "theme-color", content: "#0b1220" },
      { property: "og:title", content: "MiyaraTrader — Account workspace" },
      { property: "og:description", content: "MiyaraTrader account access and management." },
